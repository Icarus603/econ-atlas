"""
NBER 爬虫：直接使用 RSS/JSON 数据，不做额外增强。
"""
...
_enricher_mod = load_local_module(__file__, "../2_enrichers/2.4_NBER_增强器.py", "econatlas._enricher_nber")
NBEREnricher = _enricher_mod.NBEREnricher  # type: ignore[attr-defined]
