"""
配置解析模块：读取 CLI 传入的路径、运行频率、过滤条件，并检查必要的环境变量。
...
def parse_interval(text: str | None, seconds_override: int | None) -> timedelta:
    ...
    if not match:
        raise SettingsError("Invalid interval. Use formats like '12h', '2d', '30m', or pass --interval-seconds.")
